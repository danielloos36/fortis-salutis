      ...
      <div className="max-w-7xl mx-auto px-6 py-16 lg:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-neutral-400 text-sm leading-relaxed mb-5">
              ...
              auf höchstem Niveau – individuell, ganzheitlich, wirksam.
            </p>
          ...
          {/* Leistungen */}
          <div>
            <h3 className="text-[10px] font-bold uppercase tracking-[0.25em] text-neutral-400 mb-5">
              Leistungen
            </h3>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <a
                ...
                className="flex items-center gap-2.5 text-neutral-400 hover:text-white transition-colors"
              >
        ...
        <div className="border-t border-gray-800 mt-14 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <Link href="/impressum" className="text-neutral-400 hover:text-neutral-400 text-xs transition-colors">
              Impressum
            </Link>
            <Link href="/datenschutz" className="text-neutral-400 hover:text-neutral-400 text-xs transition-colors">
              Datenschutz
            </Link>
          </div>
        </div>
