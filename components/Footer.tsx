    ...
    <footer className="bg-[#0a0a0a] text-white">
      <div className="max-w-7xl mx-auto px-6 py-16 lg:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          {/* Leistungen */}
          <div>
            <h3 className="text-[10px] font-bold uppercase tracking-[0.25em] text-gray-500 mb-5">
              Leistungen
            </h3>
        ...
        <div className="border-t border-gray-800 mt-14 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <Link href="/impressum" className="text-gray-500 hover:text-gray-500 text-xs transition-colors">
              Impressum
            </Link>
            <Link href="/datenschutz" className="text-gray-500 hover:text-gray-500 text-xs transition-colors">
              Datenschutz
            </Link>
          </div>
        </div>
