    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-24">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <Link
              href="/leistungen/krankengymnastik"
              className="inline-block border border-white/40 text-white px-8 py-4 text-xs font-black uppercase tracking-[0.2em] hover:border-white hover:bg-white/10 transition-colors"
            >
              Alle Leistungen
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-gray-800/30">
            {leistungen.map((item, i) => (
              <Link
                key={item.href}
                href={item.href}
                className="group bg-[#0a0a0a] p-8 hover:bg-[#111] transition-colors flex flex-col"
              >
            ...
            <div className="bg-white p-8 flex flex-col justify-between">
              ...
              <div className="mt-8 space-y-2">
                <a
                  href="tel:+4915773327200"
                  className="block bg-wine text-white text-center py-3.5 text-xs font-bold uppercase tracking-[0.15em] hover:bg-wine-dark transition-colors"
                >
                  Anrufen
                </a>
                <a
                  ...
                  className="block border border-gray-200 text-black text-center py-3.5 text-xs font-bold uppercase tracking-[0.15em] hover:border-wine hover:bg-wine hover:text-white transition-colors"
                >
                  WhatsApp
                </a>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2">
            <Link
              ...
              className="border border-wine bg-wine text-white text-center py-3 px-3 text-xs font-bold uppercase tracking-wider"
            >
              Reinheim
            </Link>
            {standorte.map(([name, href]) => (
              <Link
                key={href as string}
                href={href as string}
                className="border border-gray-300 bg-white text-gray-900 text-center py-3 px-3 text-xs font-medium hover:border-wine hover:bg-wine hover:text-white transition-all"
              >
                {name}
              </Link>
            ))}
      ...
      <section id="kontakt" className="bg-[#0a0a0a] py-24 lg:py-32 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-7">
              {[
                ...
                <div key={row.label} className="flex items-start gap-4">
                  <div className="w-9 h-9 border border-wine flex items-center justify-center shrink-0 text-wine">
                    {row.icon}
                  </div>
                  <div>
          ...
          <div className="border border-wine/40 p-8">
            <h3 className="text-white font-black text-xl mb-6">Termin vereinbaren</h3>
            <div className="space-y-3">
              <a
                href="tel:+4915773327200"
                className="flex items-center gap-3 bg-white text-black px-6 py-4 text-xs font-bold uppercase tracking-[0.15em] hover:bg-gray-100 transition-colors"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 border border-white/20 text-white px-6 py-4 text-xs font-bold uppercase tracking-[0.15em] hover:border-wine hover:bg-wine transition-colors"
              >
